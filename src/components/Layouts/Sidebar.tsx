                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-5">
                            <li className="nav-item mb-6">
                                <ul>
                                    ...
                                    <li className="nav-item mb-6">
                                        <NavLink to="/users/user-account-settings" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Profile shop')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item mb-6">
                                        <NavLink to="/history" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Sales history')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    ...
                                    <li className="nav-item mb-6">
                                        <div className='p-3' onClick={(e) => logOut(e)}>
                                            <div className="flex items-center">
                                                <svg className="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        opacity="0.5"
