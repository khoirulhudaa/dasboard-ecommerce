                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-5">
                            <li className="nav-item mb-6">
                                <ul>
                                    ...
                                    <li className="nav-item mb-6">
                                        <NavLink to="/OnDelivery" className="group">
                                            <div className="flex items-center">
                                                <svg className="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        opacity="0.5"
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('On delivery')}</span>
                                            </div>
                                        </NavLink>
                                    </li>

                                    <li className="nav-item mb-6 bg-white hover:bg-gray-200 hover:text-red-500 rounded-md cursor-pointer active:scale-[0.98]">
